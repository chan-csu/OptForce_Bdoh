...
fprintf('\n-------***Test 3***-----------------\n')
fprintf('The norm of difference between Predicted data and experimental data for Metaclau is: %s \n ',norm(Sim_Res_Meta-table2array(EXP(1:9,4:end))))
fprintf('\nThe norm of difference between Predicted data and experimental data for iCLAU is: %s ',norm(Sim_Res_i-table2array(EXP(1:9,4:end))))
